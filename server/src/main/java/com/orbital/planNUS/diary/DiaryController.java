...
public class DiaryController {
  ...
  @PostMapping
  public ResponseEntity<Diary> createDiary(@RequestBody @Valid DiaryCreateRequest req) {
  ...
  public ResponseEntity<Diary> updateDiary(
      @PathVariable @Positive Long id, @RequestBody @Valid DiaryUpdateRequest req) {
